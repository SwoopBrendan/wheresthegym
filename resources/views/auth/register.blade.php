                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group{{ $errors->has('user_type') ? ' has-error' : '' }}">
                            <label for="type-member" class="col-md-4 control-label">Member</label>

                            <div class="col-md-6">
                                <div class="radio">
                                    <label>
                                        <input type="radio" id="type-member" name="type" {{ old('type-member') ? 'checked' : '' }}>
                                    </label>
                                </div>
                            </div>

                            <label for="type-gym" class="col-md-4 control-label">Gym</label>

                            <div class="col-md-6">
                                <div class="radio">
                                    <label>
                                        <input type="radio" id="type-gym" name="type" {{ old('type-gym') ? 'checked' : '' }}>
                                    </label>
                                </div>
